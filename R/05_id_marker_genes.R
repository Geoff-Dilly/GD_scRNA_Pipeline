...
save_plot_pdf(topmarker_dotplot, here::here(output_dir, "Plots", "Clustering_Plots", "Top_Markers_DotPlot.pdf"), height = 8, width = 12)
...
save_plot_pdf(top2markers_dotplot, here::here(output_dir, "Plots", "Clustering_Plots", "Top2_Markers_DotPlot.pdf"), height = 8, width = 12)
