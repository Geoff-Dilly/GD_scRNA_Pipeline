...
summary_list <- foreach(cluster = clusters,
  ...
  # Plot pca_plots by condition and sample
  pca_plot_by_condition <- DESeq2::plotPCA(rld, intgroup = "Treatment", ntop = 50)
  save_plot_pdf(pca_plot_by_condition, here::here("plots/deseq_plots", "pca_plots", paste0(str_replace(cluster, "_", " "), "_PCA.pdf")),
                height = 6, width = 8)

  pca_plot_by_sample <- DESeq2::plotPCA(rld, intgroup = "Sample_name", ntop = 50)
  save_plot_pdf(pca_plot_by_sample, here::here("plots/deseq_plots", "pca_plots", paste0(str_replace(cluster, "_", " "), "_sample_PCA.pdf")),
                height = 6, width = 8)
