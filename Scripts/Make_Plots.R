...
# Violin plots
nFeature_vln_byAnimal <- VlnPlot(Combined_Seurat, features = "nFeature_RNA", pt.size = 0)
pdf("Plots/Quality_Control/nFeature_vln_byAnimal.pdf", height = 4, width = 6)
print(nFeature_Vln_byAnimal)
dev.off()

nCount_vln_byAnimal <- VlnPlot(Combined_Seurat, features = "nCount_RNA", pt.size = 0)
pdf("Plots/Quality_Control/nCount_vln_byAnimal.pdf", height = 4, width = 6)
print(nCount_vln_byAnimal)
dev.off()

percent_mito_vln_byAnimal <- VlnPlot(Combined_Seurat, features = "percent_mito", pt.size = 0)
pdf("Plots/Quality_Control/pctMito_vln_byAnimal.pdf", height = 4, width = 6)
print(percent_mito_vln_byAnimal)
dev.off()

percent_ribo_vln_byAnimal <- VlnPlot(Combined_Seurat, features = "percent_ribo", pt.size = 0)
pdf("Plots/Quality_Control/pctribo_vln_byAnimal.pdf", height = 4, width = 6)
print(percent_ribo_vln_byAnimal)
dev.off()
